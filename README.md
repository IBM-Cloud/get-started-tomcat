...
Copy TomcatHelloWorldApp.war from the `target` directory into your `tomcat-install-dir` `webapps` directory.
...
Remember if you don't need your app live on Bluemix, stop it so you don't incur any unexpected charges.
